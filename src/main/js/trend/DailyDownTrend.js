...
class DailyDownTrend extends Component {
    ...
    render() {
        if (this.props.dailyDown) {
            const _ranges = this.props.dailyDown.ranges;
            var _lastquote = this.props.quote.last;
            return (
                <table>
                    <caption>{trendConsts.Daily.downtrend.caption}</caption>
                    <tbody>
                    <tr>
                        <th>Range Bottom</th>
                        <th>Range Top</th>
                    ...
                    {getTbody(_ranges, _lastquote, trendConsts.Daily.downtrend, trendLogic, alertCondition)}
                    </tbody>
                </table>
            )
        } else {
