...
public interface DailyTrendRepository extends JpaRepository<Dailytrend,Long> {
    ...
    @Query("Select new com.herringbone.stock.domain.Trend(gt1.id, g1end.close, g1start.close, gt2.trendstart.close, g1end.id," +
            ...
            "from Dailytrend gt1 left outer join gt1.previoustrend gt2 left outer join gt1.nexttrend gt3 " +
    ...
    @Query( name = "similarDailyTrends", value = "Select new com.herringbone.stock.model.HistoricalTrendElement(gt1.id, g2.close, g1.close, g3.close, g4.close, " +
            ...
            "(g3.close / g1.close), (g4.close/g3.close), g1.id, ((g2.volatility + g1.volatility + g3.volatility)/3), g1.date) " +
            STRING)
